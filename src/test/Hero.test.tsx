...
describe('Hero', () => {
  ...
  it('renders the section label in the h1', () => {
    render(<Hero sectionLabel="Monument of Triumph" hasData={true} progressFor={progressFor} />);
  ...
  it('shows "— triomphes" when hasData is false', () => {
    render(<Hero sectionLabel="Lifetime" hasData={false} progressFor={progressFor} />);
